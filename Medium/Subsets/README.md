<h2><a href="https://practice.geeksforgeeks.org/problems/subsets-1613027340/1?page=1&sortBy=submissions&searchQuery=subset">Subsets</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a set of positive integers, find all its subsets.</span></p>
...
</div><p><span style=font-size:18px><strong>Company Tags : </strong><br><code>Microsoft</code>&nbsp;<br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Backtracking</code>&nbsp;<code>Recursion</code>&nbsp;<code>Algorithms</code>&nbsp;